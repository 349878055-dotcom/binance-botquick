...
struct ParsedMarketData {
    ...
    double price;
    double quantity;
    // double liquidation_volume; // 爆仓量 -- 【注释】不再使用
    // double bid_price;          // 买一价 -- 【注释】不再使用
    // double bid_quantity;       // 买一量 -- 【注释】不再使用
    // double ask_price;          // 卖一价 -- 【注释】不再使用
    // double ask_quantity;       // 卖一量 -- 【注释】不再使用
